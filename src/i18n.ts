...
const messages: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'ui.import': 'Import',
    'ui.import_mode': 'Mode',
    'ui.import_merge': 'Merge (add/overwrite)',
    'ui.import_replace': 'Replace (wipe & import)',
    'ui.import_file': 'Import file',
    'ui.delete_project': 'Delete project',
    'ui.secrets': 'Secrets',
    'ui.transfer': 'Transfer',
    'ui.settings': 'Settings',
    'ui.mcp_loading': 'MCP loading',
    'ui.loading_eager': 'Eager (all tools)',
    'ui.loading_lazy': 'Lazy (on-demand)',
    'ui.defence_level': 'Defence level',
    'ui.low_defence': 'Low defence',
    'ui.decent_defence': 'Decent defence',
    'ui.high_defence': 'High defence',
    'ui.save_settings': 'Save settings',
    'ui.high_defence_note': 'High defence disables run_with_project_env/run_script and locks config files (chmod 600). Run zocket as a dedicated OS user (e.g., zocketd).',
  ...
  ru: {
    ...
    'ui.export': 'Экспорт',
    'ui.import': 'Импорт',
    'ui.import_mode': 'Режим',
    'ui.import_merge': 'Слияние (добавить/перезаписать)',
    'ui.import_replace': 'Заменить (очистить и импортировать)',
    'ui.import_file': 'Файл импорта',
    'ui.delete_project': 'Удалить проект',
    'ui.secrets': 'Секреты',
    'ui.transfer': 'Перенос',
    'ui.settings': 'Настройки',
    'ui.mcp_loading': 'Загрузка MCP',
    'ui.loading_eager': 'Eager (все инструменты)',
    'ui.loading_lazy': 'Lazy (по запросу)',
    'ui.defence_level': 'Уровень защиты',
    'ui.low_defence': 'Низкая защита',
    'ui.decent_defence': 'Адекватная защита',
    'ui.high_defence': 'Высокая защита',
    'ui.save_settings': 'Сохранить настройки',
    'ui.high_defence_note': 'Высокая защита отключает run_with_project_env/run_script и блокирует конфиг‑файлы (chmod 600). Запускайте zocket от отдельного пользователя (например, zocketd).',
